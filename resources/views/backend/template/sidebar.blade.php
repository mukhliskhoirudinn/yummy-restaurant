    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse {{ request()->routeIs('panel.image.*', 'panel.vidio.*') ? 'show' : '' }}"
                    ...
                    <ul class="flex-column nav">
                        ...
                        <li class="nav-item {{ request()->routeIs('panel.vidio.*') ? 'active' : '' }} ">
                            <a class="nav-link" href="{{ route('panel.vidio.index') }}">
